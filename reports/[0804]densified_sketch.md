...
| 4 (신규) | 표본 크기 | 이미지 2장 × seed 4개 그대로 — CM_1067/CM_1082 온도차(§4)를 볼 때 이미지를 더 늘리지 않으면 "일반적으로 densification이 효과 있다"고 말하기엔 근거가 약함 |
...
- 재학습 시 L1(약한 densification)로 갈지 L2/L3 정도의 밀도로 갈지 — §3.3의 포화 양상을 보면
