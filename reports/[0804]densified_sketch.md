...
**선행 지침**: `2026-08-04-stroke-densification-inference-test-guide.md` (절차), `2026-08-04-orientation-metric-implementation-guide.md` (판정 지표), `20260804shssourcediffparametercorrection.md` (PI 코드 정정 지시)
